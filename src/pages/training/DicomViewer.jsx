...
import TagsTable from './DicomTagsTable';

import './DicomStyle.css';
import {
  App,
  getDwvVersion,
  decoderScripts
...
const MyDialog = ({open, onClose, src}) => {

  const MyDWCComponent = withStyles(styles)(DwvComponent)
